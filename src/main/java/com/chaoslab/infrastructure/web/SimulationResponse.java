 ...
 * completo con su línea de tiempo (para reproducir la animación en el cliente) y el veredicto de la
 ...
 */
public record SimulationResponse(TopologyView topology, SimulationReport report, HypothesisReport hypothesis) {
}
